...
if __name__ == "__main__":
    ...
    # python fix_json.py "C:\path\to\your\semantic_prompt\json" --recursive
    # or
    # python fix_json.py "C:\path\to\your\semantic_prompt\json"
    # mine
    # python fix_json.py C:\Programs\A1111\stable-diffusion-webui\extensions\semantic_prompt\semantic\packs --recursive
